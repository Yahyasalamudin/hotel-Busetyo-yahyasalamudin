...
<head>
  ...
  <title><?= $title ?> | Hotel K2</title>
</head>

<body>

  <div class="navbar-title">
    <span class="head1">Hotel</span><span class="head2"> K2</span>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            ?>
              ...
              <a class="dropdown-item" href="<?= base_url('account/changePassword') ?>">Password</a>
              <a class="dropdown-item" href="<?= base_url('account/logout') ?>">Keluar</a>
            <?php } else {
            ?>
              <a class="dropdown-item" href="<?= base_url('account/login') ?>">Masuk</a>
              <a class="dropdown-item" href="<?= base_url('account/registration') ?>">Daftar</a>
            <?php
            } ?>
          </div>
        </li>
